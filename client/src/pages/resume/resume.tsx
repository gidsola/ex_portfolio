        ...
        <div className="section">
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <Link to="https://www.linkedin.com/in/michael-goodie/" className="contact-link" target="_blank">linkedin.com/in/michael-goodie</Link>
            </div>
            <div className="contact-item">
              <FaGithub className="contact-icon" />
              <Link to="https://github.com/gidsola" className="contact-link" target="_blank">github.com/gidsola</Link>
            </div>
            <div className="contact-item">
              <FaGlobe className="contact-icon" />
              <Link to="https://goodsie.ca" className="contact-link" target="_blank">goodsie.ca</Link>
            </div>
          </div>
        </div>
